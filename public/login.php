...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $state = login_process_submission();
    if ($state['success']) {
    ...
    <div class="relative w-full max-w-md">
        <div class="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(255,255,255,0.04))] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur-2xl sm:p-10">
            <div class="mb-8 text-center">
                <div class="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/10 text-cyan-300 shadow-lg shadow-cyan-900/20">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                        <path d="M12 2a5 5 0 0 1 5 5v1.1A3 3 0 0 1 19 11v7a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4v-7a3 3 0 0 1 2-2.9V7a5 5 0 0 1 5-5Zm3 9H9a1 1 0 0 0-1 1v6a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-6a1 1 0 0 0-1-1Zm-3-7a3 3 0 0 0-3 3v1h6V7a3 3 0 0 0-3-3Z"/>
                    </svg>
                </div>

                <h1 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">Welcome back</h1>
            ...
            <form method="POST" action="<?= e(url('/login.php')) ?>" class="space-y-5" novalidate>
                ...
                <div>
                    <label for="identifier" class="mb-2 block text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">
                        Username or Email
                    </label>
                    <div class="relative">
                        <input
            ...
            <div class="mt-8 border-t border-white/10 pt-6 text-center">
                <p class="text-sm text-gray-400">
                    New here?
                    <a href="<?= e(url('/register.php')) ?>" class="font-semibold text-cyan-400 transition hover:text-cyan-300">
                        Create an account
                    </a>
                </p>
            </div>
